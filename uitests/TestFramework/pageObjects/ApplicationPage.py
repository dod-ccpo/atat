...
class CreateApplicationPages:
    ...
    btn_special_cancel_css = "#add-app-mem > div > div:nth-child(1) > div.action-group > a"
    ...
    btn_save_css = "#add-app-mem > div > div:nth-child(2) > div.action-group > input:nth-child(1)"

    # Step 4 review, save, and add/or more team members
    btn_save_app_css = "#add-app-mem > div > div:nth-child(2) > div.action-group > input:nth-child(1)"
    ...
    def click_create_app(self):
        wait = WebDriverWait(self.driver, 20)
        wait.until(EC.presence_of_element_located((By.CSS_SELECTOR, self.btn_create_app_css))).click()
