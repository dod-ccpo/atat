...
class ReportsPages:
    ...
    def enter_portfolio_name(self, pName):
        self.driver.find_element_by_css_selector(self.btn_portfolio_name_css).send_keys(pName)

    def enter_portfolio_description(self, description):
        self.driver.find_element_by_css_selector(self.portfolio_description_css).send_keys(description)
    ...
    def enter_clin_number(self, clinNumber):
        self.driver.find_element_by_css_selector(self.txt_add_clin_number_css).send_keys(clinNumber)

    def select_idiq_number(self):
        self.driver.find_element_by_css(self.drpdn_idiq_css).click()

    def add_clin_value(self, clinValue):
        self.driver.find_element_by_css_selector(self.txt_clin_value_css).send_keys(clinValue)

    def add_obligated_clin_value(self, obligatedValue):
        self.driver.find_element_by_css_selector(self.txt_obligated_clin_css).send_keys(obligatedValue)

    def add_start_month(self, startMonth):
        self.driver.find_element_by_css_selector(self.txt_start_month_css).send_keys(startMonth)

    def add_start_day(self, startDay):
        self.driver.find_element_by_css_selector(self.txt_start_day_css).send_keys(startDay)

    def add_start_year(self, startYear):
        self.driver.find_element_by_css_selector(self.txt_start_year_css).send_keys(startYear)

    def add_end_month(self, endMonth):
        self.driver.find_element_by_css_selector(self.txt_end_month_css).send_keys(endMonth)
    ...
    def add_end_year(self, endYear):
        self.driver.find_element_by_css_selector(self.txt_end_year_css).send_keys(endYear)
