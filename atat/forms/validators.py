...
def alpha_file_pdf(message="File name must end on '.pdf'. and content only valid characters."):
    return Regexp(regex=r"^[A-Za-z0-9\-_ \.\/\\]*.pdf$", message=message, flags=re.IGNORECASE)
